...
function AboutTop() {
  return (
    <div className='md:h-44 h-32 w-full bg-gray-300 bg-opacity-25 xl:pl-32 lg:pl-24 md:pl-16 sm:pl-12 pl-4 pr-4 flex flex-col justify-center bg-no-repeat bg-cover' >
        <motion.div initial={{ x: '100vw', opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{duration:2 , type: 'spring'}} className='md:text-2xl sm:text-lg text-slate-500 font-semibold mt-2'>ALL YOU NEED TO KNOW ABOUT ESPORTS EMPIRE</motion.div>
